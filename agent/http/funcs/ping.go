...
// 			// 	Destination      []string `json:"destination"`        // 目标主机列表
// 			// 	Epoch      int      `json:"epoch"`        // 间隔时间
// 			// 	Count   int      `json:"count"`     // ping个数
// 			// 	Connections int     `json:"connections"`  // 保持的连接数
// 			// 	Dscp       []int    `json:"dscp"`         // DSCP值列表
// 			// 	UseIPv6    bool     `json:"use_ipv6"`     // 是否使用IPv6
// 			// }
// 			var PingTask send.PingTaskConfig
// 			PingTask.Destination = []string{t.Addr}
// 			PingTask.Epoch = 3

// 			// delay, err := send.Send(ipaddr, 3*time.Second, 64, i)
// 			if err == nil {
